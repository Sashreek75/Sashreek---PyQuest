        ...
        <div className="p-14 max-w-7xl mx-auto space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="space-y-4">
            ...
            <h1 className="text-6xl md:text-8xl font-extrabold text-white tracking-tight leading-none">
              Welcome, <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-400 drop-shadow-sm">{user.username}.</span>
            </h1>
              ...
              <div className="p-10 rounded-[48px] bg-[#0b0e14]/50 border border-white/5 shadow-xl">
                <div className="flex flex-col md:flex-row justify-between items-center gap-10">
                  <div className="space-y-2 text-center md:text-left">
                    <h2 className="text-4xl font-extrabold text-white tracking-tight leading-none">Architect <span className="text-indigo-400">Tier {stats.level}</span></h2>
                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex items-center gap-4">
                        ...
                        <h4 className="text-2xl font-bold text-white group-hover:text-indigo-400 transition-colors tracking-tight">{nextQuest.title}</h4>
                      </div>
            ...
            <div className="lg:col-span-4 space-y-12">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                >
                  ...
                  <div className="text-[9px] font-bold text-slate-300 uppercase tracking-widest group-hover:text-white">Repository</div>
                </button>
              </div>
            </div>
          </div>
